...
# Rulebook: Writing Unambiguous Model Instructions
...
![The Prompt Architect](images/prompts-rulebook.jpg)
...
- Every large fixed subagent block is dispatched by tag-reference, the grep is line-anchored, and the dispatched prompt holds no summarizable block. (8)
