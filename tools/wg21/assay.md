...
<img src="images/assay.png" alt="Assayer's Office" width="100%">

---

## Commands

- **Assay [path]** - run the full pipeline on a WG21 paper. Path is required. The assay report is **output**.
...
The tool's entry point. Minimum-viable input: one file path to a WG21 paper. Optional: output directory override. Ask once for the missing required input. Accept silence on optionals.
