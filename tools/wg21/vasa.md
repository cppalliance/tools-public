...
<img src="images/vasa.png" alt="The Vasa in drydock" width="100%">
...
- Writes the finished report `vasa-{slug}.md` as **output**
...
**Intermediate file:** `vasa-intermediate-{slug}.md` is **scratch**
...
**Report file:** `vasa-{slug}.md` is **output**
- Written by Step 7
- The deliverable
